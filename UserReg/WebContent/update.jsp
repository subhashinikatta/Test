...
<body >
 <form action="rest/user/updateregister" method="post" >
<center>
<div class="container">
	<div class="row">
        <div class="col-md-6">
            <form action="" method="post" id="fileForm" role="form">
            <fieldset><legend class="text-center"> Upadte Registration Page <span class="req"></span></legend>
     ...
     <br><br><br>
            <div class="form-group" >
                    ...
                    <span>Already Updated!! <a href="NewFile.jsp">Login Here</a></span>
            </div>
          </div>
